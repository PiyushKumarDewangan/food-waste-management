...
const CTA = () => {
  return (
    <section className="w-full px-4 sm:px-6 lg:px-8 py-10 sm:py-14 bg-[#F8FAF7]">
      <div className="relative overflow-hidden max-w-7xl mx-auto rounded-4xl sm:rounded-[2.5rem] bg-[#EAF5EA] shadow-sm px-6 py-10 sm:px-10 sm:py-14 lg:px-16 lg:py-16">
        {/* Decorative leaf watermark — same branch/leaf artwork as the reference design,
            ...
            between the buttons */}
        <svg
          className="pointer-events-none select-none absolute -right-4 -bottom-6 sm:right-0 sm:-bottom-4 lg:right-2 lg:bottom-0 h-[85%] sm:h-[90%] w-auto max-w-60 sm:max-w-75 lg:max-w-85 opacity-[0.16] sm:opacity-20 z-0"
          viewBox="0 0 420 400"
          fill="none"
